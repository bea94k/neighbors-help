        ...
        <div>
            <Form style={{ width: '80%' }}>
                ...
                <Form.Group controlId="formAddress">
                    ...
                    <Form.Control type="text" placeholder="Mannerheimintie 30, Helsinki" />
                </Form.Group>
                ...
                <div key={'helper-or-customer'} className="mb-3">
                    <Form.Check inline label="I want to help others" type='radio' id={'helper'} />
                    <Form.Check inline label="I need some help" type='radio' id={'customer'} />
                </div>
